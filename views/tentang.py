...
<style>
    ...
    .pipeline-num { background: #4F46E5; color: white; font-weight: 700; font-size: 0.85rem; border-radius: 50%; width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    .pipeline-text { font-size: 0.9rem; color: #374151; line-height: 1.5; }
...
<div class="card-about">
    <div class="card-about-title">🔄 Alur Pipeline Data & Model</div>
